...
class RunnerSpawner:
    def __init__(self) -> None:
        self.queue: queue.Queue[subprocess.Popen] = queue.Queue(maxsize=2)
        self.stopping = False
    ...
    def spawn_more(self) -> None:
        while not self.stopping:
            ...
            process = subprocess.Popen(
                "ulimit -v 100000000; timeout 10 downloaded-deps/deno run --allow-read run_pyodide.js",
